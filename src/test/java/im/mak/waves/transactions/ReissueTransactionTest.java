...
public class ReissueTransactionTest {
    ...
    Asset asset = Asset.id("dMjSNxoT6P9F4gQcYhg5jNGpZBrNiQrSeaGTA56zJok");
    ...
    static Stream<Arguments> transactionsProvider() {
        return Stream.of(
                arguments(1, false, TxId.id("42n6XmzySop9EhpaESAsXA3mvnZYLCpHU9skUK3Dr1N2"),
                ...
                arguments(1, true, TxId.id("BTVoDbjaF5qzW3qsDjtKu2XjbX7jRJsK7kDkH6h7mofx"),
                ...
                arguments(2, false, TxId.id("FrLcDKUTYJ42UZiS6GRkkAFykrUFrzzEAYeRc69hto5T"),
                ...
                arguments(2, true, TxId.id("DXkQ7jWwG2BiKzXEChvX1ZFij1Sj8tB56xZzFKzzKLCu"),
                ...
                arguments(3, false, TxId.id("7bg99B7Jpo7R2344xeVPbscyksLAr2sVm37ZLYtKJBV6"),
                ...
                arguments(3, true, TxId.id("AykCjr4iGEvTseRjKqdKQUdoZuBjV1LG7rZrvD3sdwSh"),
    ...
    void transferTransaction(int version, boolean reissuable, TxId expectedId, List<Proof> proofs,
        ...
        assertAll("Tx must be deserializable from expected bytes",
                () -> assertThat(deserTx.amount()).isEqualTo(Amount.of(amount, asset)),
