...
public class UpdateAssetInfoTransactionTest {
    ...
    static Stream<Arguments> transactionsProvider() {
        ...
        return Stream.of(
                arguments(1, minName, minDescription, TxId.id("5V5oDWaqB89Xux82Gd7JdzBiPmWC319EgRNjkv2VC7o4"),
                ...
                arguments(1, maxName, maxDescription, TxId.id("2FmLwK8bGwN3xiLBptA1iUeBxrtnY8Zr78KgHWfHBBPw"),
    ...
    void updateAssetInfoTransaction(int version, String name, String description, TxId expectedId, List<Proof> proofs,
