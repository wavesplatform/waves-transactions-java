    ...
    static Stream<Arguments> transactionsProvider() {
        ...
        return Stream.of(
                arguments(1, address, Function.asDefault(), payments(),
                        sponsoredFee, TxId.id("ChSBYroE3h1o95utywa82GH8RhvBh2tZSCwRuHYrUDWM"),
                ...
                arguments(1, alias, Function.as("default"), payments(Amount.of(10)),
                        fee, TxId.id("346JhuGSgcDyrYf1CYR7aX9ySo6Lpx6136kfwGmVFYBK"),
                ...
                arguments(1, alias, Function.as("function", argsV1), payments(Amount.of(20, asset)),
                        fee, TxId.id("3yhi3JvhMYfTWVFR8We3X9gWhSH7vJousayvvjrFEuVk"),
                ...
                arguments(2, address, Function.asDefault(), payments(),
                        sponsoredFee, TxId.id("2jrfokXkPtiU9Ygttxv9BnE1LYiyP7XP1muyV8rpHkCr"),
                ...
                arguments(2, alias, Function.as("default"), payments(Amount.of(10)),
                        fee, TxId.id("jVGXJgbxhCg9gLZ1bSKPiJonAaACbQa3u9j6mpd4z4y"),
                ...
                arguments(2, alias, Function.as("function", argsV2), payments(Amount.of(10), Amount.of(20, asset)),
                        fee, TxId.id("71EnNwbpssbWm2567KUBqEJn94AfwPBdhTin3NJbDojv"),
