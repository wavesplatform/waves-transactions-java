...
public class CreateAliasTransactionTest {
    ...
    static Stream<Arguments> transactionsProvider() {
        return Stream.of(
                arguments(1, TxId.id("8HSsxBsxnzBep3522R2YDkNG8eKLwa9gVuT47U7zU43R"),
                ...
                arguments(2, TxId.id("8HSsxBsxnzBep3522R2YDkNG8eKLwa9gVuT47U7zU43R"),
                ...
                arguments(3, TxId.id("Do5MYp5ueFNAdwTk6co66v6G3crf8XCXFHEK1s7h2aBm"),
    ...
    void createAliasTransaction(int version, TxId expectedId, List<Proof> proofs,
