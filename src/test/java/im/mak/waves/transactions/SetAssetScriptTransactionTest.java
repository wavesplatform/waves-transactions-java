...
public class SetAssetScriptTransactionTest {
    ...
    static Asset asset = Asset.id("HcGYEobfsHtYoRv3jWcrHPnu5joTB1NZKHfxqVfaG212");
    ...
    static Stream<Arguments> transactionsProvider() {
        return Stream.of(
                arguments(1, TxId.id("BMHqtKFidUdcCJLWVbCx8P7zESzYNDojVVrsnNDzdvCi"),
                ...
                arguments(2, TxId.id("3AH46W7qmShsPG6mGpL1E8iVrzPFsEWKTS6hu8L6eUtW"),
    ...
    void setAssetScriptTransaction(int version, TxId expectedId, List<Proof> proofs, byte[] expectedBody,
