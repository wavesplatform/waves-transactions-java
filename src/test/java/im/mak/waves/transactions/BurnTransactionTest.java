...
public class BurnTransactionTest {
    ...
    Asset asset = Asset.id("D4H5agQLLDLEjbM2ZgHoyTe9M9Apj4t1DFSDob6c5ptb");
    ...
    static Stream<Arguments> transactionsProvider() {
        return Stream.of(
                arguments(1, TxId.id("AsAoCWzNGf8Udz8sgaL6gJMjNqDCdQFfMpTvGKcApd9"),
                ...
                arguments(2, TxId.id("6L4GZVPsCo27rTwKByU37wEa2P7rhLsfgPm5BAZbqZRD"),
                ...
                arguments(3, TxId.id("EDKJAuejW9FmSSzGHPcbAB2436EBXX14Ti73cMiDGTHk"),
    ...
    void burnTransaction(int version, TxId expectedId, List<Proof> proofs,
        ...
        BurnTransaction constructedTx = new BurnTransaction(sender, Amount.of(amount, asset),
