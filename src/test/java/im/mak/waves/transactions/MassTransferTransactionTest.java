...
public class MassTransferTransactionTest {
    ...
    static Stream<Arguments> transactionsProvider() {
        ...
        Asset asset = Asset.id("CjwUuXHmQvBXtykMLDD9QXWHMqawZCW3VoomauCM1XVJ");
        ...
        return Stream.of(
                arguments(1, address, Asset.WAVES, Bytes.empty(), TxId.id("9BctskM13RG8ZpSnCexp9ZyE2ktdnK38qSMQmjxZcJTS"),
                ...
                arguments(1, alias, asset, attachment, TxId.id("31JjDMAjiZs7z5WQ946nNVqfnswPJr1BKY4VqPKwnSCp"),
                ...
                arguments(2, address, Asset.WAVES, Bytes.empty(), TxId.id("ByZGfrDr5YLvUCHWm2Rn4N2NrvYTkLjckGejw33aAFa3"),
                ...
                arguments(2, alias, asset, attachment, TxId.id("9fwbZPRhfGE5QJCf83QgW56tupfL5NiyeAr1yqxoMR9k"),
    ...
    void massTransferTransaction(int version, List<Transfer> transfers, Asset asset, byte[] attachment,
                                 TxId expectedId, List<Proof> proofs, byte[] expectedBody, byte[] expectedBytes,
