...
public class LeaseCancelTransactionTest {
    ...
    static Stream<Arguments> transactionsProvider() {
        TxId leaseId = TxId.id(new byte[TxId.BYTE_LENGTH]);
        return Stream.of(
                arguments(1, leaseId, TxId.id("2e1i8bkDFaoVGhq5qQyGUhnhoFeo71NMaeVprs2Zejzk"),
                ...
                arguments(2, leaseId, TxId.id("v65WRpS5x3yThVkPBHPQaBKa15yWC3JzYWdKEbHaYQE"),
                ...
                arguments(3, leaseId, TxId.id("5vE4BGTM583JsCjxdBGyF8MvQPVZ7i9zDY72kNaL5A1s"),
    ...
    void leaseCancelTransaction(int version, TxId leaseId, TxId expectedId, List<Proof> proofs,
