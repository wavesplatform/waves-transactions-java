...
public class TransferTransactionTest {
    ...
    static Stream<Arguments> transactionsProvider() {
        ...
        Asset asset = Asset.id("9Z9DqJz4GbrJiMDHRFdGPz4GdVy6sWzzRQKZARkvsgMp");
        ...
        return Stream.of(
                arguments(1, address, asset, Bytes.empty(), Asset.WAVES, fee, TxId.id("6EZtyjhgDk1h367vXz5wr8hNzykrmkkAQ5kYJtL41FwY"),
                ...
                arguments(1, alias, Asset.WAVES, attachment, Asset.WAVES, fee, TxId.id("5BiMMPemNvcDkx4jCLPiV5VGycN6toHCQt9Gn5yLYeoF"),
                ...
                arguments(2, address, asset, Bytes.empty(), Asset.WAVES, fee, TxId.id("68hXdLALf181LWJmV8AhUoW5XRmxjG5iG7Hu2PWb5nMT"),
                ...
                arguments(2, alias, Asset.WAVES, attachment, asset, 2, TxId.id("4MnsP1xt96TGPHPNyFW8Mo41FnU2drewHyiCFvavMJDB"),
                ...
                arguments(3, address, asset, Bytes.empty(), Asset.WAVES, fee, TxId.id("CBviNdkSRVnfqXiEH1pzCTyZjPdeCbHoDWuZm28Dcxpm"),
                ...
                arguments(3, alias, Asset.WAVES, attachment, asset, 2, TxId.id("GnjzppeMsiej7Ru5eQC65Q28dwiPWAaks1wjjU1ML4Ps"),
    ...
    void transferTransaction(int version, Recipient recipient, Asset asset, byte[] attachment, Asset feeAsset, long fee, TxId expectedId, List<Proof> proofs,
        ...
        assertAll("Tx must be deserializable from expected bytes",
                ...
                () -> assertThat(deserTx.amount().asset()).isEqualTo(asset),
