...
public class TestLeaseTransaction {
    ...
    static Stream<Arguments> transactionsProvider() {
        ...
        return Stream.of(
                arguments(1, minAlias, 1, TxId.id("4HcJAJJSmPVLw2kyZH1AUen1VDKaG3DHr8cgRJLpfNc6"),
                ...
                arguments(1, maxAlias, Long.MAX_VALUE, TxId.id("2k76csSZ1761KGBLR95zqKQ1KnoTVkMomg5NfV1W9wGN"),
                ...
                arguments(1, address, Long.MAX_VALUE, TxId.id("BMt7mhihgaMqfKYomTo8cRrJgcsMMszJakDgtRuSWo9r"),
                ...
                arguments(2, minAlias, 1, TxId.id("8FYbDJnzetZ7BKdkDFWaPWaFhXbKRJPrPcNYGidtjeXy"),
                ...
                arguments(2, maxAlias, Long.MAX_VALUE, TxId.id("B4a2ADiQx61paTNS4CVuRj7XQZxbZib4u23JRiE5HCB1"),
                ...
                arguments(2, address, Long.MAX_VALUE, TxId.id("4QLWNbA6nHcrEMq6yV8d6isEGMuZnPUP22YSuC9CAGDW"),
                ...
                arguments(3, minAlias, 1, TxId.id("65jwmmr3Yb3z2iNUMSUQuqF7PRPckhB8Z7MUgQiBXxLh"),
                ...
                arguments(3, maxAlias, Long.MAX_VALUE, TxId.id("5XXAMNKLxEy3a5Ews3cr4Vzaiw6UTuRUffQTmkDxwpbq"),
                ...
                arguments(3, address, Long.MAX_VALUE, TxId.id("96peWN7hJLzTRiT68VLxgZtAnw6gHWzX7P9mqmM2B56E"),
    ...
    void leaseTransaction(int version, Recipient recipient, long amount, TxId expectedId, List<Proof> proofs,
