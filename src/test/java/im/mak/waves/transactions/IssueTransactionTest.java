...
public class IssueTransactionTest {
    ...
    static Stream<Arguments> transactionsProvider() {
        ...
        return Stream.of(
                arguments(1, minName, minDescription, 0, false, Bytes.empty(), TxId.id("HvbnMZ82dAnFbkSX9nNnbiHHEYNWmQ1U1pb9Jn2gsKZG"),
                ...
                arguments(1, maxName, maxDescription, 8, true, Bytes.empty(), TxId.id("6kpPR9m6g6w6LP6L4MLJ898mBjuWApDQZSsyZD8t2ZKc"),
                ...
                arguments(2, minName, minDescription, 0, false, Bytes.empty(), TxId.id("C7RV4xjdjHkNbDG8suLwvjaQg88YsdfWV87hUGRhSYc1"),
                ...
                arguments(2, maxName, maxDescription, 8, true, script, TxId.id("5S2eVMCngyafyj3jojZFCBqyEB7ifGHsJKQPmXRd844n"),
                ...
                arguments(3, minName, minDescription, 0, false, Bytes.empty(), TxId.id("TrvVX73TGaAcpLU93j2KzNs23SDyWWnsY75kGwcsqRo"),
                ...
                arguments(3, maxName, maxDescription, 8, true, script, TxId.id("GTdEMD3xt1qVexDjdES2VX9G5vWFJBgfhp6wxbSFzn43"),
    ...
    void issueTransactionWithStringName(int version, String name, String description, int decimals, boolean reissuable,
                                        byte[] script, TxId expectedId, List<Proof> proofs, byte[] expectedBody,
    ...
    static Stream<Arguments> oldTransactionsProvider() {
        ...
        return Stream.of( //todo add first arg as more descriptive test name (in all suites)
                arguments(1, minName, minDescription, 0, false, Bytes.empty(), TxId.id("9XyxaGepzteh4QDBaRvNBCiNmjyNMSeEQpgu4vtJFCWJ"),
                ...
                arguments(1, maxName, maxDescription, 8, true, Bytes.empty(), TxId.id("GjDZvRJ6PuuuG9vFWrav6G3gJWSUBLrwupSxy7RJbLTw"),
                ...
                arguments(2, minName, minDescription, 0, false, Bytes.empty(), TxId.id("GHFtf9tHfYSJghU5a8LLbze3xv9Zed9hvQzh2Lh19nKh"),
                ...
                arguments(2, maxName, maxDescription, 8, true, script, TxId.id("8b8UuNVwbsZAYj6RdwwrxVZAXbx1mvtHm9YDCv9DJt1Z"),
