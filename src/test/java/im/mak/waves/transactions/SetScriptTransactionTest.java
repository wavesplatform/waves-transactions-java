...
public class SetScriptTransactionTest {
    ...
    static Stream<Arguments> transactionsProvider() {
        return Stream.of(
                arguments(1, Bytes.empty(), TxId.id("9NDmssQqrKhUux7mEFe7t5FBgN3re4sPLxtvd7kM3an"),
                ...
                arguments(1, script, TxId.id("52gNwMctfVwEwacKv8e13jjkHMBcaPPdWTAWKtohpqvq"),
                ...
                arguments(2, Bytes.empty(), TxId.id("6uUXV3hSWQwVHBrsgdVczP7fxfrdWrBVX5TueeahSBx9"),
                ...
                arguments(2, script, TxId.id("GvZChtmeLsJJ7gLUocf992kKZ2yyNaEvvdxdRJxrfjgx"),
    ...
    void setScriptTransaction(int version, byte[] script, TxId expectedId, List<Proof> proofs, byte[] expectedBody,
